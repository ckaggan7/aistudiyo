...
export default function PracticeLabPreview() {
  return (
    <Link to="/dashboard/academy/lab" className="block rounded-2xl p-6 border border-white/10 bg-gradient-to-br from-fuchsia-500/15 via-violet-500/15 to-indigo-500/15 hover:border-white/30 transition-all">
